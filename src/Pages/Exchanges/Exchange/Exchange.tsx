    ...
    <div className="exchange">
      <div className="top">
        ...
        <p>
          ...
          volume of $347 Billion, a -29.25% change in the last 24 hours.
          Currently, the 3 largest cryptocurrency exchanges are Binance,
          Coinbase Exchange, and Bybit. Total tracked crypto exchange reserves
          currently stands at $241 Billion.
        </p>
      </div>
        ...
        <div className="crypto-table">
          <div className="table-layouts">
            ...
            <div className="trust_score">
              <p className="_score">
                Trust Score <AiFillExclamationCircle />
              </p>
            </div>
            <p className="_24hr _24vol">24h Volume</p>
            <p className="monthly-visits">Year Established</p>
          ...
          {exchangeList.slice(0, 100).map((item: any, index: number) => (
            <div className="table-layouts table_info" key={index}>
              ...
              <Link className="pic_name ellipses" to={`/exchanges/${item.id}`}>
                ...
                <span
                  className={item.has_trading_incentive === true ? "" : "green"}
                >
